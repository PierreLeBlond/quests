...
export const quest = (app) => app
    .use(authenticated)
    .get("/quests", async ({ session }) => {
    ...
    .get("/quest/:questId", async ({ session, params: { questId } }) => {
    ...
    .post("/quest/:questId", async ({ session, body, params: { questId } }) => {
    console.log({ body });
    ...
    .delete("/quest/:questId", async ({ session, params: { questId } }) => {
